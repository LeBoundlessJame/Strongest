...
public class CursedFireRendering {
    ...
    public static void renderCursedFire(MatrixStack matrices, VertexConsumerProvider vertexConsumers, Entity entity, Quaternionf rotation) {
        ...
        for (MatrixStack.Entry entry = matrices.peek(); i > 0.0F; l++) {
            ...
            drawCursedFireVertex(entry, vertexConsumer, -g - 0.0F, 0.0F - j, k, o, p, red, green, blue, alpha);
            drawCursedFireVertex(entry, vertexConsumer, g - 0.0F, 0.0F - j, k, m, p, red, green, blue, alpha);
            drawCursedFireVertex(entry, vertexConsumer, g - 0.0F, 1.4F - j, k, m, n, red, green, blue, alpha);
            drawCursedFireVertex(entry, vertexConsumer, -g - 0.0F, 1.4F - j, k, o, n, red, green, blue, alpha);
            i -= 0.45F;
            j -= 0.45F;
            g *= 0.9F;
            k -= 0.03F;
