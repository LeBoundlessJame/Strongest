...
public class StrongestComponents {
    ...
    public static ComponentType<Integer> MAX_CURSED_ENERGY = DataComponentRegistry.registerComponent("max_cursed_energy", builder -> ComponentType.<Integer>builder().codec(Codec.INT));
