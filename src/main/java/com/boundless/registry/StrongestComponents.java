...
public class StrongestComponents {
    ...
    public static ComponentType<Integer> SIMPLE_DOMAIN_TICKS = DataComponentRegistry.registerComponent("simple_domain_ticks", builder -> ComponentType.<Integer>builder().codec(Codec.INT));
