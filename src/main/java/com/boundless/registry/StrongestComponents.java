...
public class StrongestComponents {
    public static ComponentType<Float> BASE_BLACK_FLASH_CHANCE = DataComponentRegistry.registerComponent("black_flash_chance", builder -> ComponentType.<Float>builder().codec(Codec.FLOAT));
    ...
    public static ComponentType<Integer> CURSED_ENERGY_RESERVES = DataComponentRegistry.registerComponent("cursed_energy_reserves", builder -> ComponentType.<Integer>builder().codec(Codec.INT));
