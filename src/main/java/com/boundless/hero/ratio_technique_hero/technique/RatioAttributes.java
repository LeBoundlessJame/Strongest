...
public class RatioAttributes {
    public static AttributeModifiersComponent ATTRIBUTES = AttributeModifiersComponent.builder()
            .add(EntityAttributes.GENERIC_MAX_HEALTH, new EntityAttributeModifier(BoundlessAPI.id("generic_max_health"), 480, EntityAttributeModifier.Operation.ADD_VALUE), AttributeModifierSlot.CHEST)
