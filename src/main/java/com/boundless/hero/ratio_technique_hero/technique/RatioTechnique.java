...
public class RatioTechnique {
    ...
    public static final TechniqueAbility COLLAPSE = TechniqueAbilityRegistry.register(new CollapseAbility().setDamage(30).setImpactTick(6).setRadius(new Vec3d(4, 3, 4)));
