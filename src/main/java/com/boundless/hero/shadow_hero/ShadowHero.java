...
public class ShadowHero extends Hero {
    ...
    public static AttributeModifiersComponent ATTRIBUTES = AttributeModifiersComponent.builder()
            .add(EntityAttributes.GENERIC_MAX_HEALTH, new EntityAttributeModifier(BoundlessAPI.identifier("generic_max_health"), 400f, EntityAttributeModifier.Operation.ADD_VALUE), AttributeModifierSlot.CHEST)
